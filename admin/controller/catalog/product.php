...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['ssp'])) {
			$data['ssp'] = $this->request->post['ssp'];
		} elseif (!empty($product_info)) {
			$data['ssp'] = $product_info['ssp'];
		} else {
			$data['ssp'] = '';
		}
	...
	public function calculateSSP() {		
		$mrpvalue =  trim($this->request->get['mrp']);
		$sspvalue = $mrpvalue - ($mrpvalue*0.1);
		$json = array();
        $json['sspValue'] = $sspvalue;
