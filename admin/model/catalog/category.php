...
class ModelCatalogCategory extends Model {
	...
	public function getCategoriesFirst($parent_id) {
	...
	public function getCategoriesList($parent_id) {
		$query = $this->db->query("SELECT category_id, name FROM ". DB_PREFIX . "category_description WHERE category_id  IN ( SELECT category_id FROM ". DB_PREFIX . "category WHERE parent_id = ".(int)$parent_id.")");
		return $query->rows;
	}
