...
class ControllerCatalogCategory extends Controller {
	...
	public function subCategoriesList() {
		...
		$this->load->model('catalog/category');
		$results = $this->model_catalog_category->getCategoriesList($this->request->get['parent_category_value']);
		foreach ($results as $result) {
			$json[] = array(
				'category_id' 	=> $result['category_id'],
				'name'        	=> $result['name'],
		...
		$this->load->model('catalog/filter');
		$filters = $this->model_catalog_filter->requestFilters($this->request->get['parent_category_value']); 
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			if($filter_data['filter_name'] == ''){
				$results = $this->model_catalog_category->getCategoriesFirst(0);
			}
			else			
				$results = $this->model_catalog_category->getCategories($filter_data);
