...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			// Postcard Manager
			$postcard_manager = array();
			
			if ($this->user->hasPermission('access', 'pincode/indianpin')) {
				$postcard_manager[] = array(
					'name'	   => $this->language->get('text_indianpin'),
					'href'     => $this->url->link('pincode/indianpin', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			
			if ($this->user->hasPermission('access', 'pincode/pinimport')) {
				$postcard_manager[] = array(
					'name'	   => $this->language->get('text_pinimport'),
					'href'     => $this->url->link('pincode/pinimport', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
				
			if ($this->user->hasPermission('access', 'pincode/pinnew')) {
				$postcard_manager[] = array(
					'name'	   => $this->language->get('text_pinnew'),
					'href'     => $this->url->link('pincode/pinnew', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
						
			if ($this->user->hasPermission('access', 'pincode/pinsetting')) {		
				$postcard_manager[] = array(
					'name'	   => $this->language->get('text_pinsetting'),
					'href'     => $this->url->link('pincode/pinsetting', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
