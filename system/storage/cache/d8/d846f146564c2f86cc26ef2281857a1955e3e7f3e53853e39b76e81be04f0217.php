...
class __TwigTemplate_ad78a8ea2d6787078d650ca8a8e61bdebd08ad3a69db87b7e86f619fba21f78c extends Twig_Template
{
...
\t\t\tdocument.getElementById(\"otpverf\").style.display = 'block';
...
\t\t\t\tdocument.getElementById(\"otpverf\").style.display = 'none';
\t\t\t\tdocument.getElementById(\"msg\").innerHTML = \"Verified\";
\t\t\t\tdocument.getElementById(\"msg\").style.color = 'green';
\t\t\t}
\t\t\telse{
\t\t\t\tdocument.getElementById(\"error\").innerHTML = \"Please re-enter the otp\";
